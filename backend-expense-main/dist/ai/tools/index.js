...
exports.READ_ONLY_TOOLS = exports.DESTRUCTIVE_TOOLS = exports.AI_TOOLS = void 0;
exports.AI_TOOLS = [
    // ─── Expense Management ────────────────────────────────────────────────────
    {
        type: 'function',
        function: {
            name: 'create_expense',
            description: 'Create a new expense transaction. Call when the user mentions spending, paying, or buying something. Extract amount, category, note, and date from context.',
            parameters: {
                type: 'object',
                properties: {
                    amount: {
                    ...
                    categoryName: {
                        type: 'string',
                        description: 'Category name matching user categories (e.g., Food, Transport, Shopping, Health, Rent). Use best match.',
                    },
                    note: {
                        type: 'string',
                    ...
                    date: {
                        type: 'string',
                        description: 'Date in YYYY-MM-DD format. Infer from context: "yesterday" → previous day, "last Monday" → calculate. Default: today.',
                    },
                    isRecurring: {
                        type: 'boolean',
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Update an existing transaction. Requires the transaction ID. First use get_transactions to find the ID if not known.',
            parameters: {
                type: 'object',
                properties: {
                    transactionId: {
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Delete a transaction permanently. Requires the transaction ID. Confirm with user before calling.',
            parameters: {
                type: 'object',
                properties: {
                    transactionId: {
    ...
    // ─── Income Management ─────────────────────────────────────────────────────
    {
        ...
        function: {
            name: 'create_income',
            description: 'Record income. Call when user mentions receiving money, salary, payment, or earnings.',
            parameters: {
                type: 'object',
                properties: {
                    amount: {
    ...
    // ─── Transaction Retrieval ─────────────────────────────────────────────────
    {
        ...
        function: {
            ...
            description: 'Retrieve user transactions with optional filters. Use to look up specific transactions before updating/deleting.',
            parameters: {
                type: 'object',
                properties: {
                    type: {
    ...
    // ─── Analytics ─────────────────────────────────────────────────────────────
    {
        ...
        function: {
            ...
            description: 'Get total spending and income for a time period. Use for questions like "how much did I spend this month?"',
            parameters: {
                type: 'object',
                properties: {
                    period: {
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Get spending broken down by category for a period. Use for questions about which category costs most.',
            parameters: {
                type: 'object',
                properties: {
                    period: {
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Compare spending/income between two time periods. Use for month-over-month or week-over-week comparisons.',
            parameters: {
                type: 'object',
                properties: {
                    period1: {
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Detect unusual or abnormal spending patterns. Use when user asks about risky spending or financial warnings.',
            parameters: {
                type: 'object',
                properties: {},
                required: [],
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Get a complete financial overview: net balance, total income, total expenses, this month vs last month. Use as a starting context or when user asks for a general summary.',
            parameters: {
                type: 'object',
                properties: {},
                required: [],
    ...
    // ─── Predictions & Estimation ──────────────────────────────────────────────
    {
        ...
        function: {
            ...
            description: 'Estimate or predict monthly spending based on historical patterns. Use for forecasting questions.',
            parameters: {
                type: 'object',
                properties: {
                    categoryName: {
    ...
    },
    {
        ...
        function: {
            ...
            description: 'Calculate how long it takes to save for a target amount, or how much can be saved monthly.',
            parameters: {
                type: 'object',
                properties: {
                    targetAmount: {
                    ...
                    monthlyContribution: {
                        type: 'number',
                        description: 'Optional: monthly savings amount. If omitted, calculated from income minus expenses.',
                    },
                },
...
exports.DESTRUCTIVE_TOOLS = new Set([
    'create_expense',
    'create_income',
    'update_transaction',
    'delete_transaction',
